...
then
    ...
    echo "Turning on Security in the cluster" 
    echo " "
    ctool secure -s -i -a -r dse.internal --dseauth "{'default_scheme':'internal','other_schemes':['internal','ldap']}" -j Storage
    ...
    echo "Turning on Security in the cluster" 
    echo " "
    ctool secure -s -i -a -r dse.internal --dseauth "{'default_scheme':'internal','other_schemes':['internal','ldap']}" -j Monitor
    ...
    echo "Turning on Security in the cluster" 
    echo " "
    ctool secure -s -i -a -r dse.internal --dseauth "{'default_scheme':'internal','other_schemes':['internal']}" -j LCM
